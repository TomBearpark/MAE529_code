...
# Cost results table
# Load the cost restuls from problem 1, as a comparison
df1 = load_results("cost_results", "1", "8_weeks", wd)
df1.Start_costs = 0.0
# Load in the integer UC version
df2 = load_results("cost_results", "2", "8_weeks", wd)
# Append together and save
...
# Compare costs across model runs. 
...
# Save the generation breakdown, for ggploting using the R script
